...
if (isset($_GET['cid'])) {
    ...
    $sql = "SELECT c.student_name, c.course_name, c.issued_date, s.school_name, s.website_link
            FROM certificates c
...
echo "  <meta name='description' content='Bootstrap 4 Landing Page Template For Online Courses'>";
echo "  <meta name='author' content='Xiaoying Riley at 3rd Wave Media'>";
...
echo "                              </div><!--//item-->";
echo "                              <div class='item col-6 col-lg-3 mb-3 mb-lg-0'>";
echo "                                  <div class='data'>140+</div>";
echo "                                  <div class='meta'>Resources</div>";
echo "                              </div><!--//item-->";
echo "                              <div class='item col-6 col-lg-3 mb-3 mb-lg-0'>";
echo "                                  <div class='data'>5+</div>";
echo "                                  <div class='meta'>Tests</div>";
echo "                              </div><!--//item-->";
echo "                          </div><!--//row-->";
...
echo "                                      This certifies that {$certificate['student_name']} has successfully completed the course {$certificate['course_name']}.";
echo " ";
echo "Issued on {$certificate['issued_date']} by International Institute of Tourism and Hospitality.";
echo "";
echo "This certificate has been verified through the official records of the International Institute of Tourism and Hospitality and is recognized as valid.";
echo "                                  </p>";
...
echo "                                      <div class='form-intro text-center mb-3'>Please contact ITH at info@ithacademy.co or leave your email below and we will get back to you.</div>";
...
echo "                                          </form>";
echo "                                         <br>";
echo "                                              <a href='https://ithacademy.co'><button class='btn btn-primary btn-primary w-100'>Visit Our Main Website</button></a>";
...
echo "              <a class='theme-link' href='#' target='_blank'>Certificate Verification</a> by ITH";
echo "          </div>";
